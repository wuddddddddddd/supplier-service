...
/**
 * @author wjd
 * @description 单据生成规则配置信息请求实体.
 * @date 2022-06-06
 */
@ApiModel(value="单据生成规则配置信息请求实体")
@Data
@EqualsAndHashCode(callSuper=false)
public class FlowNumberConfigRequest implements Serializable {
    private static final long serialVersionUID = -2943865131482080959L;
