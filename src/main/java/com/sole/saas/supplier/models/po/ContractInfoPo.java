...
/**
 * @author wjd
 * @description 供应商合同信息数据库映射实体.
 * @date 2022-05-23
 */
@ApiModel(value="供应商合同信息数据库映射实体")
@Data
@EqualsAndHashCode(callSuper=false)
@TableName("supplier_contract_info")
public class ContractInfoPo extends Model<ContractInfoPo> {
    private static final long serialVersionUID = -5150677212311936074L;
