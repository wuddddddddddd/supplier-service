...
@TableName("supplier_qualification_info")
public class QualificationInfoPo extends Model<SupplierBasicInfoPo> {

    private static final long serialVersionUID = -8742305053680016898L;
