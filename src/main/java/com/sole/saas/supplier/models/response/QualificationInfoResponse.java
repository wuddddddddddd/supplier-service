...
/**
 * @author wjd
 * @description 供应商资质信息响应实体.
 * @date 2022-05-16
 */
@ApiModel(value="供应商资质信息响应实体")
@Data
@EqualsAndHashCode(callSuper=false)
public class QualificationInfoResponse implements Serializable {

    private static final long serialVersionUID = 7385101788979501690L;
