...
/**
 * @author wjd
 * @description 供应商资质信息数据库映射实体.
 * @date 2022-05-16
 */
@ApiModel(value="供应商资质信息数据库映射实体")
@Data
@EqualsAndHashCode(callSuper=false)
@TableName("supplier_qualification_info_log")
public class QualificationInfoLogPo extends Model<SupplierBasicInfoPo> {
    private static final long serialVersionUID = 6063804437536043384L;
